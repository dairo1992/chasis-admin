...
// Componentes de usuario (los crearás después)
// import { UserListComponent } from './presentation/user-list.component';
// import { UserDetailComponent } from './presentation/user-detail.component';
// import { UserCreateComponent } from './presentation/user-create.component';
...
export const userRoutes: FeatureRoute[] = [
    {
        ...
        children: [
            {
                path: '',
                component: HomeComponent, // Temporalmente, cambiar por UserListComponent
                data: {
                    hideInMenu: true
                }
            },
            {
                path: 'create',
                component: HomeComponent, // Temporalmente, cambiar por UserCreateComponent
                data: {
                    hideInMenu: true
                }
            },
            {
                path: ':id',
                component: HomeComponent, // Temporalmente, cambiar por UserDetailComponent
                data: {
                    hideInMenu: true
                }
            }
...
// Función para registrar las rutas del feature
